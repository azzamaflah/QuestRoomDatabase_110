package com.example.pammmm.ui.view.mahasiswa
...
import com.example.pammmm.ui.customewidget.TopAppBar
import com.example.pammmm.ui.navigation.AlamatNavigasi
import com.example.pammmm.ui.viewmodel.FormErrorState
import com.example.pammmm.ui.viewmodel.MahasiswaEvent
import com.example.pammmm.ui.viewmodel.MahasiswaViewModel
import com.example.pammmm.ui.viewmodel.MhsUiState
import com.example.pammmm.ui.viewmodel.PenyediaViewModel
...
fun InsertMhsView(
    ...
    val uiState = viewModel.uiState // amil ui state dari viewmodel
    ...
    Scaffold(
        modifier = modifier,
        snackbarHost = { SnackbarHost(hostState = snackbarHostState) } //tepatkan snackbar di scaffold
    ){ padding ->
        Column(
            modifier = Modifier
                .fillMaxSize()
